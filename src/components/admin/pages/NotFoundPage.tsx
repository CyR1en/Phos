...
export function NotFoundPage() {
  ...
  return (
    <div class="max-w-3xl">
      <div class="mb-8">
        <p class="text-phos-micro font-mono uppercase tracking-wider text-phos-coral mb-2">notFound</p>
        <h2 class="font-display text-phos-heading text-phos-ink">404</h2>
